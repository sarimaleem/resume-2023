  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed a fault-tolerant FastAPI webserver to asynchronously execute training and inference jobs}
        \resumeItem{Integrated PostgreSQL to store metadata about asynchronous jobs and fine-tune layers}
        \resumeItem{Cached storage and retrieval of fine-tune layers with Redis, increasing performance by 10x}
